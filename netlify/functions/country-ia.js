...
function createCountryIaHandler({ getStore, verifyToken: verify = verifyToken, getSecret = () => process.env.STUDIO_PASSWORD, now = () => new Date().toISOString() } = {}) {
  const resolveStore = getStore || require("@netlify/blobs").getStore;
